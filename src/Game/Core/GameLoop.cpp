...
GameLoop::GameLoop(GameState& gameState, MovementHandler& movementSystem, PlayerSystem& playerSystem, ConnectionManager& connectionManager, FoodController& foodController) 
	: gameState(gameState), movementSystem(movementSystem), playerSystem(playerSystem), connectionManager(connectionManager), foodController(foodController) {
